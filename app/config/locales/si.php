<?php
return [
    'settings.inspire' => '"බුද්ධිමත් වීමේ කලාව යනු නොසලකා හැරිය යුතු දේ දැන ගැනීමේ කලාවයි."', // This is the line printed in the homepage and console 'view-source'
    'settings.locale' => 'si',
    ...
    'account.emails.invitation.title' => 'සාදරයෙන් පිළිගනිමු , %s කණ්ඩායමට %s ව්‍යාපෘතියෙහි',
